...
/******/ 		__webpack_require__.o = (obj, prop) => (Object.prototype.hasOwnProperty.call(obj, prop))
	...
	(() => {
      ...
      `;
		...
		var accordion_min = __webpack_require__(296);
		// EXTERNAL MODULE: ./node_modules/scroll-lock/dist/scroll-lock.js
		var scroll_lock = __webpack_require__(488);
		// EXTERNAL MODULE: ./node_modules/fslightbox/index.js
		var fslightbox = __webpack_require__(784);
		// EXTERNAL MODULE: ./node_modules/@oveleon/sticky-header/build/sticky-header.cjs.js
		var sticky_header_cjs = __webpack_require__(432);
		var sticky_header_cjs_default = /*#__PURE__*/__webpack_require__.n(sticky_header_cjs);
		// EXTERNAL MODULE: ./node_modules/aos/dist/aos.js
		var aos = __webpack_require__(564);
		var aos_default = /*#__PURE__*/__webpack_require__.n(aos);
		// EXTERNAL MODULE: ./node_modules/jquery/dist/jquery.js
		var jquery = __webpack_require__(588);
		...
		document.addEventListener('DOMContentLoaded', function () {
			...
			function showPopup1() {
				var btns = document.querySelectorAll('.showPopup');
			...
			showPopup1();
			function showPopup2() {
				var btns = document.querySelectorAll('.showPopup2');
			...
			showPopup2();
			function showPopup3() {
				var btns = document.querySelectorAll('.showPopup3');
			...
			showPopup3();
			function showPopup4() {
				var btns = document.querySelectorAll('.showPopup4');
			...
			showPopup4();
			function closePopup() {
				var btns = document.querySelectorAll('.popup__close');
			...
			if (window.innerWidth < 768) {
				var swiper2 = new Swiper('.steps-slider', _defineProperty(_defineProperty({
					modules: [Autoplay],
					direction: 'horizontal',
					slidesPerView: "auto",
					spaceBetween: 0
				}, "spaceBetween", 16), "autoplay", {
					delay: 3000
				}));
			}
			var swiper3 = new Swiper('.locations-slider', {
				modules: [Navigation],
				navigation: {
			...
			if (window.innerWidth < 768) {
				var swiper4 = new Swiper('.option-slider', {
					modules: [Pagination],
					slidesPerView: 4,
					pagination: {
						el: '.swiper-pagination',
			...
			if (innerWidth < 768) {
				var swiper6 = new Swiper('.about__slider', {
					slidesPerView: "auto",
					spaceBetween: 16
				});
			}
			function moveEl() {
				var el = document.querySelector('.footer__bottom-right-aside .btn--black');
				var newWrap = document.querySelector('.footer__block');
				newWrap.append(el);
			}
			if (window.innerWidth < 768) {
				moveEl();
			...
			function quiz() {
				var wrap = document.querySelector('.quiz');
				var items = wrap.querySelectorAll('.item');
				var firstlistCheckboxes = wrap.querySelectorAll('.quiz__first-step input');
				var price = 0;
				firstlistCheckboxes.forEach(function (checkbox) {
					checkbox.addEventListener('change', function () {
						var allChecks = wrap.querySelectorAll('.input');
				...
				items.forEach(function (item) {
					var btnNext = item.querySelector('.nextBtn');
					var btnPrev = item.querySelector('.prevBtn');
					var inputs = item.querySelectorAll('input');
					var items = wrap.querySelectorAll('item');
					// шаг назад
					if (btnPrev) {
						btnPrev.addEventListener('click', function () {
							wrap.querySelectorAll('.price__total').forEach(function (total) {
				...
				inputs.forEach(function (input) {
					input.addEventListener('change', function () {
						...
						price = checkboxesChecked.reduce(function (partialSum, a) {
							return partialSum + a;
						}, 0);
			...
			function showMore() {
				if (document.querySelectorAll('.section-block').length > 0) {
					var btns = document.querySelectorAll('.showMore');
					btns.forEach(function (btn) {
						btn.addEventListener('click', function () {
			...
			showMore();
			function hideTeam() {
				var els = document.querySelectorAll('.team__wrap .team__item');
				var btn = document.querySelector('.team__btn');
				if (window.innerWidth < 768) {
			...
			function validatePopup() {
				var wraps = document.querySelectorAll('.form');
				wraps.forEach(function (wrap) {
					var phone = wrap.querySelector('.tel');
					var btn = wrap.querySelector('.form__submit');
			...
			function changeOptions() {
				var wrap = document.querySelector('.card__options-block');
				var items = wrap.querySelectorAll('.card__options-item input');
				var countOptions = document.querySelector('#countOptions');
				var descr = document.querySelector('.card__descr');
				var name = document.querySelector('.card__descr-name');
				var text = document.querySelector('.card__descr-text');
				items.forEach(function (item) {
					var count = 0;
					item.addEventListener('change', function () {
						count = wrap.querySelectorAll('.card__options-item input:checked').length;
						if (item.checked) {
							name.innerHTML = "".concat(item.nextElementSibling.getAttribute('data-name'));
							text.innerHTML = "".concat(item.nextElementSibling.getAttribute('data-descr'));
						}
						if (count == 0) {
		...
		window.addEventListener("DOMContentLoaded", function () {
			...
			if (window.innerWidth > 767) {
				var heightHeight = document.querySelector('header').offsetHeight;
				var main = document.querySelector('main');
				main.style.marginTop = "".concat(heightHeight, "px");
				new (sticky_header_cjs_default())({
					selector: 'header',
					// Header or container selector
					linkSelector: 'a, strong',
					scrollSettings: {
						startHeight: 100,
						// Starting height for the container
						stopHeight: 100,
						// StopHeight for the container after reaching the stopPosition
						stopPosition: 200,
						// Container will shrink to stopHeight until reaching this position
			...
			if (document.querySelector('#options')) {
				...
				var calculate = function calculate() {
					var result = 0;
					var startPrice = document.querySelector('.start-price').textContent;
					var pricesValue = document.querySelectorAll('input:checked[name="options"]');
					pricesValue.forEach(function (item) {
						var value = item.getAttribute('data-price');
						result = result + +value;
					});
					document.querySelector('.total-price').innerHTML = result + +startPrice;
				};
				var checkboxes = _toConsumableArray(document.querySelectorAll('#options input'));
				// const items = [...document.querySelector('.card__pic').children];

				checkboxes.forEach(function (n) {
					return n.addEventListener('change', onChange);
				});
			}
			function hiddenCards() {
				var wrap = document.querySelector('.catalog-block__index');
				wrap.querySelectorAll('.card-item').forEach(function (card, i) {
					if (i > 5) {
		...
		jquery_default()('.form').submit(function (e) {
			e.preventDefault();
			var answers = [];
			var inputsCurrent = document.querySelectorAll('.quiz input:checked');
			inputsCurrent.forEach(function (input) {
				answers.push(input.dataset.question, input.dataset.value);
			});
			var strAnswers = JSON.stringify(answers);
			var user_name = jquery_default()(this).find('[name="name"]').val();
			var user_tel = jquery_default()(this).find('[name="phone"]').val();
			var user_email = jquery_default()(this).find('[name="email"]').val();
		...
		jquery_default()(function () {
			(jquery_default()).fn.scrollToTop = function () {
				jquery_default()(this).hide().removeAttr("href");
				if (jquery_default()(window).scrollTop() != "0") {
					jquery_default()(this).fadeIn("slow");
				}
				var scrollDiv = jquery_default()(this);
				jquery_default()(window).scroll(function () {
					if (jquery_default()(window).scrollTop() == "0") {
						jquery_default()(scrollDiv).fadeOut("slow");
					} else {
						jquery_default()(scrollDiv).fadeIn("slow");
					}
				});
				jquery_default()(this).click(function () {
		...
		jquery_default()(function () {
			jquery_default()("#btnUp").scrollToTop();
		});
